    ...
    func scene(_ scene: UIScene, restoreInteractionStateWith stateRestorationActivity: NSUserActivity) {
        ...
        case .menu(let category):
            let menuTableViewController = storyboard.instantiateViewController(
                ...
                creator: {(coder) in return MenuTableViewController(coder: coder, category: category) }
            )
        ...
        case .menuItemDetail(let menuItem):
            ...
            storyboard.instantiateViewController(
                ...
                creator: {(coder) in return MenuTableViewController(coder: coder, category: menuItem.category)})
